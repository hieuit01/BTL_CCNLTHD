# Generated by Django 5.1.7 on 2025-05-16 09:44
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('user', 'Người dùng'), ('nutritionist', 'Chuyên gia dinh dưỡng'), ('trainer', 'Huấn luyện viên'), ('admin', 'Admin')], default='user', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('connected_nutritionist', models.ForeignKey(blank=True, limit_choices_to={'expert_type': 'nutritionist'}, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='connected_nutritionist', to='healths.expert')),
                ('connected_trainer', models.ForeignKey(blank=True, limit_choices_to={'expert_type': 'trainer'}, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='connected_trainer', to='healths.expert')),
            ],
            options={
                'verbose_name': 'user',
                'verbose_name_plural': 'users',
        ...
        migrations.CreateModel(
            ...
            options={
                'unique_together': {('meal_plan', 'meal', 'meal_time')},
            },
        ),
        migrations.AddField(
            model_name='mealplan',
        ...
        migrations.AddField(
            model_name='workoutplan',
            name='user_profile',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='workout_plans', to='healths.regularuser'),
        ),
        migrations.CreateModel(
            name='Reminder',
            fields=[
                ...
                ('user_profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reminders', to='healths.regularuser')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='health_tracking', to='healths.regularuser')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='health_profiles', to='healths.regularuser')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='health_journals', to='healths.regularuser')),
            ],
            options={
                'ordering': ['-date'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reviewer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reviews', to='healths.regularuser')),
            ],
            options={
