# Generated by Django 5.1.7 on 2025-05-12 14:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('connected_nutritionist', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='connected_nutritionist', to='healths.nutritionistprofile')),
                ('connected_trainer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='connected_trainer', to='healths.trainerprofile')),
            ],
            options={
                'verbose_name': 'user',
                'verbose_name_plural': 'users',
        ...
        migrations.AddField(
            model_name='workoutplan',
            name='user_profile',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='workout_plans', to='healths.userprofile'),
        ),
        migrations.CreateModel(
            name='Reminder',
            fields=[
        ...
        migrations.AddField(
            model_name='mealplan',
            name='user_profile',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='meal_plans', to='healths.userprofile'),
        ),
        migrations.CreateModel(
            name='HealthTracking',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='health_profiles', to='healths.userprofile')),
            ],
            options={
                'abstract': False,
            },
